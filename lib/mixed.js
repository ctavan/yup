...
SchemaType.prototype = {
  ...
  _validate: function _validate(_value) {
    ...
    var validationParams = { value: value, path: path, schema: this, options: options, label: label, sync: sync };
    var initialTests = [];
  ...
  validateSync: function validateSync(value) {
    ...
    var schema = this.resolve(options);
    return schema._validate(value, _extends({}, options, { sync: true }));
  },
  ...
  isValidSync: function isValidSync(value, options) {
    var result = true;
    this.validateSync(value, _extends({}, options)).catch(function (err) {
