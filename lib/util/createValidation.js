...
function createErrorFactory(_ref) {
  ...
  return function createError() {
    ...
    return Object.assign(new _ValidationError2.default(formatError(message, params), value, path, type), { params: params });
  };
}
...
function createValidation(options) {
  ...
  function validate(_ref3) {
    ...
    return _ZalgoPromise2.default.resolve(test.call(ctx, value), sync).then(function (validOrError) {
